...
// token transfers
// ----------------------------------------------------------------------------
contract GamCoinTestToken is ERC20Interface, Owned, SafeMath {
    ...
    // Constructor
    // ------------------------------------------------------------------------
    function GamCoinTestToken() public {
        symbol = "GAMCT";
        name = "GamCoinTest Token";
        decimals = 2;
        _totalSupply = 1400000000;
